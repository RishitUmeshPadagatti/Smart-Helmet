#!/usr/bin/env python3
"""
EasyOCR Plate Extraction Wrapper
Called from Node.js to extract license plates from violation frames
...
ml_model_dir = utils_dir.parent.parent / 'ML_model'
sys.path.insert(0, str(ml_model_dir))

# Write debug info immediately
debug_log = utils_dir / 'extract_debug.log'
with open(str(debug_log), 'w') as f:
    f.write(f"Script started\n")
    f.write(f"Utils dir: {utils_dir}\n")
